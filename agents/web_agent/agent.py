...
WORKSPACES_FOLDER = os.getenv("OUTPUT_FOLDER")
    
class WebAgent:
    """
    A Web agent that can create 
    and is built using google's agent development framework.
    """

    def __init__(self):
        self.system_instruction = load_instructions_file("agents/web_agent/instructions.txt")
        self.description = load_instructions_file("agents/web_agent/description.txt")
        self._user_id = "web_agent_user"
